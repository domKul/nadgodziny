...
class OvertimeConsoleFacadeConfig {
    ...
    private final OvertimeFacadeFetchImpl ovetimeFacadeFetch;
     ...
     OvertimeConsoleFacadeConfig() {
        this.ovetimeFacadeFetch = new OvertimeFacadeFetchImpl(List.of(
                new OvertimeEntity(LocalDate.parse("2023-09-12"),"nadgodziny",5),
                new OvertimeEntity(LocalDate.parse("2024-01-13"),"nadgodziny",5),
                new OvertimeEntity(LocalDate.parse("2024-01-14"),"zlecenie",8)
        ));
    ...
    public OvertimeConsoleFacadeConfig(List<OvertimeEntity> overtimes) {
        this.inMemoryDBForTests = new InMemoryDBForTests();
